...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    public static final Color WINDOW_BG_COLOR = Color.AQUA;
    public static final Color BOARD_BG_COLOR = Color.AQUAMARINE;
    ...
    private void drawGridlines(Group root) {
        ...
        while (index < 8) {
            ...
            Rectangle horizontalLine = getLine(BOARD_PADDING,
                    xAndY + 64 * index, BOARD_X_AND_Y, thickness);
    ...
    private void handleInput(int value, Object source) {
        listener.onSudokuInput(
                ...
                ((SudokuTextField) source).getX(), value
        );
    }
}
